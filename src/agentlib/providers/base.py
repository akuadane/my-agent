...
from llmx import Message, TextGenerationConfig, TextGenerator
...
class AssistantMessage(Message):
    ...
    def __str__(self) -> str:
        return (
            f"AssistantMessageStream(content='{self.content}', "
            f"thinking='{self.thinking}', tool_calls='{self.tool_calls}', "
            f"done='{self.done}')"
        )
